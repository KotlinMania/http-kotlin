...
kotlin {
    ...
    swiftExport {
        moduleName = "Http"
        flattenPackage = "io.github.kotlinmania.http"
    }

    android {
        namespace = "io.github.kotlinmania.http"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "http-kotlin", version.toString())
    ...
    pom {
        ...
        scm {
            url.set("https://github.com/KotlinMania/http-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/http-kotlin.git")
