...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Http.swiftmodule/`
...
//      `import Http` above would fail at compile time.
//
//   2. The static archive `libHttp.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Http" }` and
//      `flattenPackage = "io.github.kotlinmania.http"` configuration in
