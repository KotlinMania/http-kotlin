...
This file is the quick-reference operating contract for http-kotlin. The longer
...
http-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`http`](https://crates.io/crates/http). Upstream Rust is the behavioral oracle while the
