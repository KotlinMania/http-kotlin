# Agent guide — http-kotlin

Quick reference for translators. Long-form discipline is in [CLAUDE.md](CLAUDE.md).

## What this repo is

Clean-room Kotlin Multiplatform port of the upstream Rust crate [`http`](https://crates.io/crates/http). Every Kotlin file is a faithful translation of one Rust file. No JVM-only deps, no Java imports, no shortcuts via established Java/Kotlin libraries.
...
Provenance gate: `ast_distance --deep tmp/http/src rust src/commonMain/kotlin/io/github/kotlinmania/http kotlin`.
